    ...
    return (
        <div className="books-details">
            {Object.keys(book).length === 0 ? (
                ...
                <>
                <img src={book.volumeInfo.imageLinks.thumbnail} alt="book poster" />
                <div className="book-details-data">
                    ...
                    <div className="book-des">{book.volumeInfo.description ? book.volumeInfo.description.substring(0, 250) + "..." : ""}</div>
                    ...
                    <div className="book-btns">
                        <a target="_blank" href={book.volumeInfo.previewLink}><button className="btn">Now Read!</button></a>
                        <a target="_blank" href={book.volumeInfo.infoLink}><button className="btn">More Info!</button></a>
                    </div>
